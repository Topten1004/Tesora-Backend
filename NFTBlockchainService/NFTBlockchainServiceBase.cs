...
{
    /// <summary>
    /// NFTBlockchainService Service
    /// </summary>
    public partial class NFTBlockchainServiceBase
    {
        ...
        public NFTBlockchainServiceBase(HttpClient httpClient, IConfiguration configuration)
        {
            _httpClient = httpClient;

            var env = configuration["Environment:Prefix"];

            _tokenClientId = configuration["Authorization:TokenClientId"];
            _tokenClientSecret = configuration[$"Authorization:{env}TokenClientSecret"];
            _tokenGrantTyoe = configuration["Authorization:TokenGrantType"];
            _tokenScope = configuration["Authorization:TokenScope"];
        }
