...
namespace NFTDatabaseService
{
    ...
    /// <summary>
    /// NFTDatabaseService Service
    /// </summary>
    public partial class NFTDatabaseServiceBase
    {
        ...
        public NFTDatabaseServiceBase(HttpClient httpClient, IConfiguration configuration)
        {
        ...
        public async Task MakeServicePutCall(string apiEndPoint)
        {
            bool haveRecords = false;
            int tryCount = 0;
