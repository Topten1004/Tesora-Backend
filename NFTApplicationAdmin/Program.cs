...
using NFTApplicationAdmin.Infrastructure.Swagger;
...
/*
var authBaseUrl = builder.Configuration[$"Authorization:{env}TokenServer"];
...
var baseAddress = builder.Configuration[$"NFTDatabaseService:{env}BaseUrl"];
builder.Services.AddNFTDatabaseService(baseAddress);
